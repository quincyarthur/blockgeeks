...
contract ERC20 is IERC20 {
  ...
  uint256 internal _totalSupply = 10000;
  ...
  */
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    require(value <= _balances[msg.sender], "Spending request exceeds available balance");
    require(value <= _allowed[msg.sender][to], "Amount exceeds allowable spending limit" );
  ...
  function approve(address spender, uint256 value) public returns (bool) {
    ...
    require(value <= _balances[msg.sender], "Spending request exceeds current balance");
  ...
  function transferFrom(address from, address to, uint256 value) public returns (bool) {
    // TODO: Your Code Here
    require(to != address(0));
    require(value <= _balances[from],"Spending request exceeds current balance");
    require(value <= _allowed[from][to], "Amount exceeds allowable spending limit" );
